...
public class OwnerController {
    ...
    @Autowired
    public OwnerController(PetDemoService clinicService) {
        this.petDemoService = clinicService;
    }
    ...
    public String initUpdateOwnerForm(@PathVariable("ownerId") int ownerId, Model model) {
        Owner owner = this.petDemoService.findOwnerById(ownerId);
    ...
    public ModelAndView showOwner(@PathVariable("ownerId") int ownerId) {
        ...
        mav.addObject(this.petDemoService.findOwnerById(ownerId));
        return mav;
    }
